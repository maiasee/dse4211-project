...
def compute_metrics(log_returns):
    """
    Compute performance metrics for weekly log returns.
    """
...
def main():
    ...
    print(reg_w.describe())
    print("Null Values in Daily Log Returns:")
    print(daily_log_returns.isnull().sum().sum())
